...
const Announments = () => {
  ...
  <div className="whitespace-nowrap">
    <button className="focus:outline-4 rounded-xl bg-emerald-400 px-4 py-3 font-medium text-white shadow-md outline-white transition hover:bg-emerald-500">Try these now</button>
  </div>
</div>
