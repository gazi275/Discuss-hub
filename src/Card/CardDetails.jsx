	...
	<div className="bg-white p-8 rounded-lg shadow-md max-w-md">
		...
		<div className="flex items-center justify-between mb-4">
			<div className="flex items-center space-x-2">
				...
				<div>
					<p className="text-gray-800 font-semibold">{details.name}</p>
					<p className="text-gray-500 text-sm">Posted {details.time}</p>
				</div>
			</div>
		...
		<div className="mb-4">
			<p className="text-gray-800"> {details.description} <a  className="text-blue-600">#{details.tag}</a>
				
			</p>
		</div>
		
		<div className="mb-4">
			<img src={details.image} alt="Post Image" className="w-full h-48 object-cover rounded-md"/>
		</div>
...
<button className=" justify-center items-center gap-2 px-2 hover:bg-gray-50 rounded-full p-1">
        ...
        <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <Link to='/comment'>
            <button for="comment" className="sr-only">See comment</button>
            </Link>
